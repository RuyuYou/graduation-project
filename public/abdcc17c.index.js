...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactCookieBanner = __webpack_require__(280);
	...
	var _UserCenter = __webpack_require__(384);
	...
	var Main = function (_Component) {
	  ...
	  _createClass(Main, [{
	    key: 'requireCookie',
	    value: function requireCookie(nextState, replace, next) {
	      var authState = (0, _reactCookieBanner.cookie)('authState');
	      if (authState !== '200') {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(_reactRouter.Route, { path: 'index', component: _Home2.default }),
	        React.createElement(_reactRouter.Route, { path: 'userCenter', component: _UserCenter2.default })
	      );
	    }
	  }]);
	...
	var RootApp = (0, _reactRedux.connect)(mapStateToProps)((0, _reactRouter.withRouter)(Main));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(269);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashOmit = __webpack_require__(284);

	var _lodashOmit2 = _interopRequireDefault(_lodashOmit);

	var _tcombReact = __webpack_require__(300);

	var _browserCookieLite = __webpack_require__(358);

	var _styleUtils = __webpack_require__(359);

	var _styleUtils2 = _interopRequireDefault(_styleUtils);

	_tcombReact.t['interface'].strict = true;

	var Props = {
	  children: _tcombReact.t.maybe(_tcombReact.t.union([_tcombReact.t.ReactChildren, _tcombReact.t.Function])),
	  message: _tcombReact.t.maybe(_tcombReact.t.String),
	  onAccept: _tcombReact.t.maybe(_tcombReact.t.Function),
	  link: _tcombReact.t.maybe(_tcombReact.t['interface']({
	    msg: _tcombReact.t.maybe(_tcombReact.t.String),
	    url: _tcombReact.t.String,
	    target: _tcombReact.t.maybe(_tcombReact.t.enums.of(['_blank', '_self', '_parent', '_top', 'framename']))
	  })),
	  buttonMessage: _tcombReact.t.maybe(_tcombReact.t.String),
	  cookie: _tcombReact.t.maybe(_tcombReact.t.String),
	  cookieExpiration: _tcombReact.t.maybe(_tcombReact.t.union([_tcombReact.t.Integer, _tcombReact.t['interface']({
	    years: _tcombReact.t.maybe(_tcombReact.t.Number),
	    days: _tcombReact.t.maybe(_tcombReact.t.Number),
	    hours: _tcombReact.t.maybe(_tcombReact.t.Number)
	  })])),
	  dismissOnScroll: _tcombReact.t.maybe(_tcombReact.t.Boolean),
	  dismissOnScrollThreshold: _tcombReact.t.maybe(_tcombReact.t.Number),
	  closeIcon: _tcombReact.t.maybe(_tcombReact.t.String),
	  disableStyle: _tcombReact.t.maybe(_tcombReact.t.Boolean),
	  styles: _tcombReact.t.maybe(_tcombReact.t.Object),
	...
	var CookieBanner = (function (_React$Component) {
	  ...
	  function CookieBanner() {
	    ...
	    _classCallCheck(this, _CookieBanner);

	    _React$Component.apply(this, arguments);

	    this.state = { listeningScroll: false };

	    this.addOnScrollListener = function (props) {
	    ...
	    this.onScroll = function () {
	      ...
	      if (window.pageYOffset > _this.props.dismissOnScrollThreshold) {
	        _this.onAccept();
	      }
	    };

	    this.getSecondsSinceExpiration = function (cookieExpiration) {
	      if (_tcombReact.t.Integer.is(cookieExpiration)) {
	      ...
	      var _cookieExpiration = _extends({
	        years: 0, days: 0, hours: 0
	      }, cookieExpiration);

	      var years = _cookieExpiration.years;
	      var days = _cookieExpiration.days;
	      var hours = _cookieExpiration.hours;
	    ...
	    this.onAccept = function () {
	      ...
	      var cookieExpiration = _props2.cookieExpiration;
	      var onAccept = _props2.onAccept;

	      _browserCookieLite.cookie(cookie, true, _this.getSecondsSinceExpiration(cookieExpiration));
	    ...
	    this.getStyle = function (style) {
	      ...
	      var disableStyle = _props3.disableStyle;
	      var styles = _props3.styles;

	      if (!disableStyle) {
	        // apply custom styles if available
	        return _extends({}, _styleUtils2['default'].getStyle(style), styles[style]);
	      }
	    };

	    this.getCloseButton = function () {
	      var _props4 = _this.props;
	      var closeIcon = _props4.closeIcon;
	      var buttonMessage = _props4.buttonMessage;

	      if (closeIcon) {
	        return _react2['default'].createElement('i', { className: closeIcon, onClick: _this.onAccept, style: _this.getStyle('icon') });
	      }
	      return _react2['default'].createElement(
	        'div',
	        { className: 'button-close', onClick: _this.onAccept, style: _this.getStyle('button') },
	        buttonMessage
	      );
	    };
	    ...
	    this.getBanner = function () {
	      ...
	      if (children) {
	        if (_tcombReact.t.Function.is(children)) {
	          return children(_this.onAccept);
	        }
	        return children;
	      }

	      var props = _lodashOmit2['default'](_this.props, Object.keys(Props));
	      var computedClassName = _classnames2['default']('react-cookie-banner', className);
	      return _react2['default'].createElement(
	        'div',
	        _extends({}, props, { className: computedClassName, style: _this.getStyle('banner') }),
	        _react2['default'].createElement(
	          'span',
	          { className: 'cookie-message', style: _this.getStyle('message') },
	          message,
	          _this.getLink()
	        ),
	        _this.getCloseButton()
	      );
	    };

	    this.hasAcceptedCookies = function () {
	      return typeof window !== 'undefined' && _browserCookieLite.cookie(_this.props.cookie);
	    };
	  }

	  CookieBanner.prototype.componentDidMount = function componentDidMount() {
	    this.addOnScrollListener();
	  };

	  CookieBanner.prototype.render = function render() {
	    return this.hasAcceptedCookies() ? null : this.getBanner();
	  };

	  CookieBanner.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	  ...
	  CookieBanner.prototype.componentWillUnmount = function componentWillUnmount() {
	    this.removeOnScrollListener();
	  };

	  _createClass(CookieBanner, null, [{
	    key: 'defaultProps',
	    value: {
	  ...
	  var _CookieBanner = CookieBanner;
	  CookieBanner = _tcombReact.props(Props, { strict: false })(CookieBanner) || CookieBanner;
	  return CookieBanner;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(285),
	    baseDifference = __webpack_require__(286),
	    baseFlatten = __webpack_require__(291),
	    bindCallback = __webpack_require__(294),
	    pickByArray = __webpack_require__(295),
	    pickByCallback = __webpack_require__(296),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(287),
	    cacheIndexOf = __webpack_require__(288),
	    createCache = __webpack_require__(289);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// core
	var t = __webpack_require__(303);

	// types
	t.Any = __webpack_require__(309);
	t.Array = __webpack_require__(317);
	t.Boolean = __webpack_require__(318);
	t.Date = __webpack_require__(320);
	t.Error = __webpack_require__(321);
	t.Function = __webpack_require__(322);
	t.Nil = __webpack_require__(323);
	t.Number = __webpack_require__(324);
	t.Integer = __webpack_require__(326);
	t.IntegerT = t.Integer;
	t.Object = __webpack_require__(332);
	t.RegExp = __webpack_require__(333);
	t.String = __webpack_require__(334);
	t.Type = __webpack_require__(335);
	t.TypeT = t.Type;
	...
	// combinators
	t.dict = __webpack_require__(336);
	t.declare = __webpack_require__(337);
	t.enums = __webpack_require__(340);
	t.irreducible = __webpack_require__(310);
	t.list = __webpack_require__(341);
	t.maybe = __webpack_require__(342);
	t.refinement = __webpack_require__(327);
	t.struct = __webpack_require__(344);
	t.tuple = __webpack_require__(350);
	t.union = __webpack_require__(351);
	t.func = __webpack_require__(352);
	t.intersection = __webpack_require__(353);
	t.subtype = t.refinement;
	t.inter = __webpack_require__(354); // IE8 alias
	t['interface'] = t.inter;

	// functions
	t.assert = t;
	t.update = __webpack_require__(356);
	t.mixin = __webpack_require__(338);
	t.isType = __webpack_require__(314);
	t.is = __webpack_require__(331);
	t.getTypeName = __webpack_require__(313);
	t.match = __webpack_require__(357);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNil = __webpack_require__(305);
	var fail = __webpack_require__(306);
	var stringify = __webpack_require__(307);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFunctionName = __webpack_require__(308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var irreducible = __webpack_require__(310);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var assert = __webpack_require__(303);
	var isString = __webpack_require__(311);
	var isFunction = __webpack_require__(304);
	var forbidNewOperator = __webpack_require__(312);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getTypeName = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isType = __webpack_require__(314);
	var getFunctionName = __webpack_require__(308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var irreducible = __webpack_require__(310);
	var isBoolean = __webpack_require__(319);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var refinement = __webpack_require__(327);
	var Number = __webpack_require__(324);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var assert = __webpack_require__(303);
	var isTypeName = __webpack_require__(328);
	var isFunction = __webpack_require__(304);
	var forbidNewOperator = __webpack_require__(312);
	var isIdentity = __webpack_require__(329);
	var create = __webpack_require__(330);
	var is = __webpack_require__(331);
	var getTypeName = __webpack_require__(313);
	var getFunctionName = __webpack_require__(308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var assert = __webpack_require__(303);
	var Boolean = __webpack_require__(318);
	var isType = __webpack_require__(314);
	var getTypeName = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var isType = __webpack_require__(314);
	var getFunctionName = __webpack_require__(308);
	var assert = __webpack_require__(303);
	var stringify = __webpack_require__(307);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isType = __webpack_require__(314);
	var isNil = __webpack_require__(305);
	var mixin = __webpack_require__(338);
	var getTypeName = __webpack_require__(313);
	var isUnion = __webpack_require__(339);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var isNil = __webpack_require__(305);
	var assert = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTypeName = __webpack_require__(328);
	var isFunction = __webpack_require__(304);
	var isMaybe = __webpack_require__(343);
	var isIdentity = __webpack_require__(329);
	var Any = __webpack_require__(309);
	var create = __webpack_require__(330);
	var Nil = __webpack_require__(323);
	var forbidNewOperator = __webpack_require__(312);
	var is = __webpack_require__(331);
	var getTypeName = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var assert = __webpack_require__(303);
	var isTypeName = __webpack_require__(328);
	var String = __webpack_require__(334);
	var Function = __webpack_require__(322);
	var isBoolean = __webpack_require__(319);
	var isObject = __webpack_require__(315);
	var isNil = __webpack_require__(305);
	var create = __webpack_require__(330);
	var getTypeName = __webpack_require__(313);
	var dict = __webpack_require__(336);
	var getDefaultInterfaceName = __webpack_require__(345);
	var extend = __webpack_require__(346);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArray = __webpack_require__(316);
	var mixin = __webpack_require__(338);
	var isStruct = __webpack_require__(347);
	var isInterface = __webpack_require__(348);
	var isObject = __webpack_require__(315);
	var refinement = __webpack_require__(327);
	var decompose = __webpack_require__(349);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var assert = __webpack_require__(303);
	var isTypeName = __webpack_require__(328);
	var FunctionType = __webpack_require__(322);
	var isArray = __webpack_require__(316);
	var list = __webpack_require__(341);
	var isObject = __webpack_require__(315);
	var create = __webpack_require__(330);
	var isNil = __webpack_require__(305);
	var isBoolean = __webpack_require__(319);
	var tuple = __webpack_require__(350);
	var getFunctionName = __webpack_require__(308);
	var getTypeName = __webpack_require__(313);
	var isType = __webpack_require__(314);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction = __webpack_require__(304);
	var isArray = __webpack_require__(316);
	var forbidNewOperator = __webpack_require__(329);
	var is = __webpack_require__(331);
	var getTypeName = __webpack_require__(313);
	var isIdentity = __webpack_require__(329);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginReducer = __webpack_require__(361);

	var _loginReducer2 = _interopRequireDefault(_loginReducer);

	var _errSent = __webpack_require__(362);

	var _errSent2 = _interopRequireDefault(_errSent);

	var _leftNav = __webpack_require__(363);

	var _leftNav2 = _interopRequireDefault(_leftNav);

	var _breadcrumb = __webpack_require__(365);
	...
	var rootReducer = (0, _redux.combineReducers)({
	  isJumped: _loginReducer2.default,
	  errSent: _errSent2.default,
	  navigator: _leftNav2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _menuData = __webpack_require__(364);
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case 'UPDATE_URI':
	      {
	        var path = action.uri.pathname.replace('/teacher-admin-web', '');
	        var uri = path === '/' ? '/index' : path;
	        return _menuData2.default.filter(function (nav) {
	          return nav.level === 2;
	        }).map(function (nav) {
	          return Object.assign({}, nav, { selected: uri.indexOf(nav.uri) >= 0 });
	        });
	      }
	  }
	  return state;
	    ...
	    case 'UPDATE_URI':
	      {
	        ...
	        var uri = path === '/' ? '/index' : path;
	        var breadcrumb = [];
	        _menuData2.default.find(function (item) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginForm = __webpack_require__(372);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _common = __webpack_require__(373);

	var _validate = __webpack_require__(375);

	var _validate2 = _interopRequireDefault(_validate);

	var _superagent = __webpack_require__(377);
	...
	var _constant = __webpack_require__(382);
	...
	var LoginForm = function (_Component) {
	  ...
	  _createClass(LoginForm, [{
	    ...
	    value: function checkLogin(e) {
	      ...
	      if (this.validateInput()) {
	        ...
	        this.setState({
	          ...
	          var account = _this2.account.value;
	          var password = _this2.password.value;
	          var captcha = _this2.captcha.value;

	          _superagent2.default.post('/api/login').send({ account: account, password: password, captcha: captcha }).end(function (req, res) {
	            _this2.setState({ loading: false });
	            if (res.body.status === _constant2.default.httpCode.FORBIDDEN) {
	              _this2.setState({ captchaError: '验证码错误' });
	            } else if (res.body.status === _constant2.default.httpCode.UNAUTHORIZED) {
	              _this2.setState({
	                accountError: '用户名或密码错误',
	                passwordError: '用户名或密码错误'
	              });
	            } else if (res.body.status === _constant2.default.httpCode.OK) {
	              _this2.props.dispatch({
	                type: 'NO_USER',
	                authState: res.body.status
	              });
	              _this2.props.router.push(URI_PREFIX + '/');
	            }
	          });
	        });
	      }
	    ...
	    value: function validateInput() {
	      ...
	      var captcha = this.captcha.value;
	      var errorInputMessage = (0, _validate2.default)({ account: account, password: password, captcha: captcha }, constraints);
	      var validateResult = {};

	      for (var key in errorInputMessage) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        { id: 'login-form', className: 'col-md-4 col-md-offset-4 col-sm-offset-2 col-sm-8 col-xs-offset-1 col-xs-10' },
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            null,
	            React.createElement(
	              _common.InputWrapper,
	              { warning: this.state.accountError },
	              React.createElement(
	                'div',
	                { className: !this.state.accountError ? 'input-info row' : 'input-info-null row' },
	                React.createElement(
	                  'div',
	                  { className: 'col-xs-11 no-padding' },
	                  React.createElement('input', { type: 'text', className: 'input-form col-xs-12', ref: function ref(_ref) {
	                      _this3.account = _ref;
	                    },
	                    placeholder: '\u90AE\u7BB1' })
	                ),
	                React.createElement(
	                  'i',
	                  { className: 'input-icon fa fa-user col-xs-1 text-center' },
	                  ' '
	                )
	              )
	            ),
	            React.createElement(
	              _common.InputWrapper,
	              { warning: this.state.passwordError },
	              React.createElement(
	                'div',
	                { className: !this.state.passwordError ? 'input-info row' : 'input-info-null row' },
	                React.createElement(
	                  'div',
	                  { className: 'col-xs-11 no-padding' },
	                  React.createElement('input', { type: 'password', className: 'input-form col-xs-12', ref: function ref(_ref2) {
	                      _this3.password = _ref2;
	                    },
	                    placeholder: '\u5BC6\u7801' })
	                ),
	                React.createElement(
	                  'i',
	                  { className: 'input-icon fa fa-lock col-xs-1 text-center' },
	                  ' '
	                )
	              )
	            ),
	            React.createElement(
	              _common.InputWrapper,
	              { warning: this.state.captchaError },
	              React.createElement(
	                'div',
	                {
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'col-xs-11 no-padding' },
	                  React.createElement('input', { type: 'text', className: 'input-form col-xs-12', ref: function ref(_ref3) {
	                      _this3.captcha = _ref3;
	                    },
	                    placeholder: '\u9A8C\u8BC1\u7801' })
	                ),
	                React.createElement(
	                  'i',
	                  { className: 'input-icon fa fa-umbrella col-xs-1 text-center' },
	                  ' '
	                )
	              ),
	              React.createElement(
	                'div',
	                { className: 'col-md-4 col-xs-6 captchar no-padding' },
	                React.createElement('img', { className: 'pull-right', src: '/api/captcha.jpg', alt: '' })
	              )
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'button',
	                  { type: 'button', className: 'pull-right btn btn-sm btn-primary',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'a',
	              { href: '#', 'data-target': '#signup-box', className: 'user-forgot-link pull-right' },
	              '\u5FD8\u8BB0\u5BC6\u7801 \xA0',
	              React.createElement(
	                'i',
	                { className: 'ace-icon fa fa-arrow-right' },
	                ' '
	              )
	            )
	          )
	...
	exports.default = (0, _reactRedux.connect)(function () {
	  return {};
	})((0, _reactRouter.withRouter)(LoginForm));
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputWrapper = __webpack_require__(374);

	var _InputWrapper2 = _interopRequireDefault(_InputWrapper);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.InputWrapper = _InputWrapper2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputWrapper = function (_Component) {
	  ...
	  _createClass(InputWrapper, [{
	    key: 'render',
	    value: function render() {
	      var ifShowWarning = !!this.props.warning;
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'row warning' + (ifShowWarning ? '' : ' warning-hidden') },
	          React.createElement(
	            'div',
	            { className: 'col-xs-12' },
	            React.createElement(
	              'i',
	              { className: 'fa fa-warning warning-icon' },
	              ' '
	            ),
	            React.createElement(
	              'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(exports, module, define) {
	  ...
	  validate.exposeModule(validate, this, exports, module, __webpack_require__(376));
	}).call(this,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requestBase = __webpack_require__(379);
	...
	var request = module.exports = __webpack_require__(381).bind(null, Request);
	  ...
	  _createClass(Home, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          'h1',
	          { className: 'text-center', style: { color: '#438EB9' } },
	          '\u7BA1\u7406\u4E3B\u9875'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserCenter = function (_Component) {
	  ...
	  function UserCenter() {
	    ...
	    return _possibleConstructorReturn(this, (UserCenter.__proto__ || Object.getPrototypeOf(UserCenter)).apply(this, arguments));
	  }
